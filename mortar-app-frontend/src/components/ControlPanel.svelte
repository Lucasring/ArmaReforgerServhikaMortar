<script lang="ts">
    ...
    import ControlPanelCache from "./ControlPanelCache.svelte";
...
<div class="flex flex-col gap-4 w-75 p-5 bg-stone-700 h-screen">
    ...
    <!-- Header -->
    <h2 class="text-xl text-center font-bold text-stone-300">Mortar Helper V3.0.0</h2>
    ...
    <!-- Mortar Cache -->
    <ControlPanelCache></ControlPanelCache>
    
    <!-- Instruction Block -->
    <div class="bg-stone-600 rounded-lg p-4 text-stone-300">
